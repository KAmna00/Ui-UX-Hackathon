  ...
  return (
    <div className="w-full">
      ...
      <div className="flex">
        ...
        <div
          className={`bg-white px-8 w-[320px] max-h-full h-max-[1660px] shadow-sm lg:flex flex-col ${
            isOpen ? "block" : "hidden"
        ...
        <div
          className={`max-w-[1280px] w-full  mx-auto py-8 px-0 bg-[#F6F7F9] max-h-full h-max relative   ${
            isOpen ? "hidden" : "block"
          }`}
        >
          <div className="flex justify-center items-center lg:flex-row flex-col bg-white rounded gap-10 m-5">
            ...
            <div className="sm:max-w-[492px] max-w-[320px]  max-h-[508px]">
              <div className="space-y-5">
                ...
                <div className="relative lg:w-[492px] md:w-[475px] max-h-[360px] bg-blue-700 p-4 rounded  space-y-6">
                  <div className=" flex flex-col max-w-[372px] gap-2">
                    ...
                    <p className="text-white text-[16px] max-w-[284px] font-medium">
                ...
                <div className="flex justify-between items-center lg:max-w-[492px]">
                  <div className="border-2  rounded w-[152px] h-[124px] group hover:border-blue-700">
                    <Image
                      src="/image/View 1.png"
                      alt="view"
                      width={148}
                      height={125}
                      className="rounded group-hover:scale-90 duration-500 transition-all"
                    />
                  </div>
                  <div className="border-2  rounded w-[152px] h-[124px] group hover:border-blue-700">
                    <Image
                      src="/image/View 2.png"
                      alt="view"
                      width={148}
                      height={125}
                      className="rounded group-hover:scale-90 duration-500 transition-all"
            ...
            <div className="sm:max-w-[492px] max-w-[320px] max-h-full   space-y-8 p-2 ">
              ...
              {/* Paragraph */}
              <div>
                <p className="text-[20px] font-normal text-[#596780]">
              ...
              <div className="flex sm:justify-between items-center sm:flex-row flex-col justify-center">
                <div className="space-y-2">
                  <div className="flex justify-between items-center gap-4">
                    <p className="text-[20px] font-normal text-[#90A3BF]">
                      Type Car
                    </p>
                    <p className="text-[20px] font-semibold text-[#90A3BF]">
                      Sport
                    </p>
                  </div>
                  <div className="flex justify-between items-center gap-4">
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-[16px] text-[#90A3BF] font-bold line-through">
                    $100.00
                  </p>
                </div>
                <Button className="text-[16px] font-semibold text-white bg-blue-700 px-5 py-1 rounded h-[44px] hover:bg-blue-600">
          ...
          <div className="bg-white m-5 rounded lg:p-4 p-2 space-y-2">
            ...
            <div className="flex gap-3 items-center mb-6">
              ...
              <div className="w-[44px] h-[28px] bg-blue-700 flex justify-center items-center rounded">
            ...
            <div className="flex justify-between items-center ">
              ...
              <div className="flex flex-col gap-2">
                <div>
                  <h1 className="text-[14px] font-medium text-[#90A3BF] text-right">
                    21 July 2022
                  </h1>
                </div>
                <div className="flex gap-1">
            ...
            <div className="flex justify-center items-center ml-12">
              <p className="text-[14px] font-normal text-[#596780] ">
            ...
            <div className="mt-8 flex justify-center items-center">
              <Button className="text-[16px] font-semibold text-[#90A3BF]">
                Show All{" "}
                <span>
                  <ChevronDown width={16} hanging={16} />
                </span>
              </Button>
            </div>
          </div>
          ...
          <div className="flex  justify-between items-center m-5">
            ...
            <Link href="/" className="text-[16px] font-semibold text-blue-700">
              View All
            </Link>
          </div>
            ...
            <div className="bg-white w-[304px] h-[388px] p-4 rounded-[10px] flex justify-center items-center relative">
              <div className="space-y-8 ">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <Button className="text-[16px] font-semibold text-white bg-blue-700 md:px-4 px-2 py-1 rounded h-[44px] hover:bg-blue-600">
                    Rent Now
                  </Button>
                </div>
              </div>
            ...
            <div className="bg-white w-[304px] h-[388px] p-4 rounded-[10px] flex justify-center items-center relative">
              <div className="space-y-8">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <Button className="text-[16px] font-semibold text-white bg-blue-700 md:px-4 px-2 rounded h-[44px] hover:bg-blue-600">
                    Rent Now
                  </Button>
                </div>
              </div>
