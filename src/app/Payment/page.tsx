...
export default function Payment() {
  return (
    <div className="bg-[#F6F7F9] max-w-[1440px] mx-auto">
      <Header />
      <div className="py-10 px-5 flex justify-center lg:items-start items-center gap-8 lg:flex-row flex-col-reverse">
        ...
        <div className="max-w-[852px] h-auto sm:ml-0 ml-5">
            ...
            <div className="mt-4 flex justify-between items-center md:flex-row flex-col">
              <label className="text-[16px] font-semibold ">
                ...
                <Input
                  ...
                  className="border-none pl-2 bg-[#f6f7f9] text-[#90A3BF] text-[14px] font-medium rounded w-[350px] h-[56px]"
                />
              </label>
              <label className="text-[16px] font-semibold">
                Phone Number
                <Input
                  ...
                  className="border-none pl-2 bg-[#f6f7f9] text-[#90A3BF] text-[10px] font-medium rounded w-[350px] h-[56px]"
                />
              </label>
            </div>
            <div className="mt-4 flex justify-between items-center md:flex-row flex-col">
          ...
          <div className="bg-white p-4 mt-10 rounded ">
            ...
            <div className="mt-4 flex justify-between items-center md:flex-row flex-col">
              <label className="text-[16px] font-semibold relative">
                Location
                <Input
                  type="text"
                  ...
                  className="border-none pl-2 bg-[#f6f7f9] text-[#90A3BF] text-[14px] font-medium rounded w-[350px] h-[56px]"
                />
                <ChevronDown className="absolute top-7 right-5 w-3 text-[#90A3BF]" />
              </label>
              <label className="text-[16px] font-semibold relative ">
                Date
                <Input
          ...
          <div className="bg-white p-4 rounded mt-10">
            ...
            <div className="bg-[#F6F7F9] rounded py-2">
              <div className="flex justify-between items-center gap-2 mx-4">
                ...
                <div className="flex justify-center items-center gap-2">
                  <Image
                    ...
                    height={16}
                  />
                  <Image src="/image/mc.png" alt="img" width={32} height={20} />
                </div>
              </div>
              ...
              <div className="mt-4 flex justify-between items-center md:flex-row flex-col mx-4">
                <label className="text-[16px] font-semibold ">
                  ...
                  <Input
                    ...
                    className="border-none pl-2 bg-white text-[#90A3BF] text-[14px] font-medium rounded w-[350px] h-[56px]"
                  />
                </label>
                <label className="text-[16px] font-semibold">
                  Expiration Date
                  <Input
                    ...
                    className="border-none pl-2 bg-white text-[#90A3BF] text-[10px] font-medium rounded w-[350px] h-[56px]"
                  />
                </label>
              </div>
            ...
            {/* Paypal */}
            <div className="mt-4 flex justify-between items-center flex-row  rounded bg-[#F6F7F9] p-4 ">
              <div className="flex justify-center items-center gap-2">
          ...
          <div className="bg-white p-4 mt-10 rounded ">
            ...
            {/* agree 1 */}
            <div className="mt-4 flex justify-between items-center md:flex-row flex-col rounded bg-[#F6F7F9] p-4 ">
              <div className="flex justify-center items-center gap-2">
                <Checkbox className="rounded w-[20px] h-[20px]" />
                <span className="text-[16px] font-semibold text-[#1F2544]">
            ...
            <div className="mt-4">
              <Button className="bg-PrimaryBlue text-white text-[16px] font-bold rounded px-4">
                Sent Now
              </Button>
            </div>
            ...
            <div className="my-4 ">
              <Image
                ...
                className="mb-2"
              />
              <h1 className="text-[16px] font-semibold text-[#1F2544] mb-2">
        ...
        <div className="max-w-[492px] h-auto bg-white rounded p-4">
          ...
          <div className=" border-t-2 border-black/10 ">
            <div className="flex justify-between mt-4 items-center">
              <p className="text-[12px] font-semibold text-[#90A3BF]">
                Subtotal
              </p>
              <p className="text-[16px] font-semibold">$80.00</p>
            </div>
            <div className="flex justify-between  items-center">
              <p className="text-[12px] font-semibold text-[#90A3BF]">Tax</p>
          ...
          <div className="flex">
            <Input
              type="text"
              className="border-none bg-[#F6F7F9] pl-2 rounded text-[#90A3BF] text-[14px] font-medium"
              placeholder="Apply Promo Code"
            />
            <Button className="bg-[#F6F7F9] rounded px-4 py-2 text-[12px] font-semibold hover:t-blue-500">
              Apply now
            </Button>
          </div>
          <br />
