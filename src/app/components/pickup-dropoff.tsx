        ...
        <div className="flex justify-between items-center lg:flex-row flex-col">
          <div className="p-3 bg-white max-w-[582px] space-y-1 shadow-md rounded">
            ...
            <div className="flex justify-start items-center gap-2">
              <Input
                type="checkbox"
                className=" h-3 w-3  focus:ring-2 focus:ring-blue-700  active:bg-gray-300 cursor-pointer"
              />
                ...
                <div className=" flex flex-col p-2 ">
                  ...
                  <div className="flex flex-row justify-start items-center gap-2">
                    <Input
                      ...
                      className="h-6  auto border-none active:text-[12px]"
                    />
                    <span>
                      {" "}
                ...
                <div className=" flex flex-col p-2">
                  ...
                  <div className="flex flex-row justify-start items-center gap-2">
                    <Input
                      ...
                      className="h-6  auto border-none  active:text-[12px] text-[#90A3BF]"
                    />
          ...
          {/* Center Part */}
          <div className="w-[60px] h-[60px] bg-blue-600 rounded flex justify-center items-center">
            <Image
          ...
          <div className="p-3 bg-white max-w-[582px] space-y-2 shadow-md rounded">
            ...
            <div className="flex justify-start items-center gap-2">
              <Input
                type="checkbox"
                className=" h-3 w-3  focus:ring-2 focus:ring-blue-600  active:bg-gray-300 cursor-pointer"
              />
                ...
                <div className=" flex flex-col p-2 ">
                  ...
                  <div className="flex flex-row justify-start items-center gap-2">
                    <Input
                      ...
                      name="cities"
                      placeholder="Select your city"
                      className="h-6  auto border-none text-[#90A3BF] active:text-[12px]"
                    />
                    <span>
                      {" "}
                      <ChevronDown width={12} height={12} />{" "}
